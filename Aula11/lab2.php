...
<html lanb="pt-br">
    ...
    <body>
        ...
        <form action="/php/exercs/bd/01_cadastro_pessoa.php" method="post">
        ...
        <!--
        <form action="/php/exercs/bd/01_cadastro_pessoa_lista.php" method="post">
          <fieldset style="width: 40%;">
            <legend>Pesquisa:</legend>
            <input style="width: 300px" type="text" id="campo_primeiro_nome" name="campo_primeiro_nome" maxlenght="150"/>
          </fieldset>
        </form>
        -->
     </body>
